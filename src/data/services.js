...
export const services = [
  {
    ...
    included: [
      { title: "Business Websites", body: "Multi-page sites built around how your customers actually search and buy." },
      { title: "E-commerce Sites", body: "Product catalogues, payments and order management, built to scale." },
      { title: "Landing Pages", body: "Focused, fast-loading pages for a single campaign, offer or launch." },
      { title: "Custom Builds", body: "Bespoke functionality where an off-the-shelf platform will not do." },
      { title: "Website Redesigns", body: "A modern rebuild of an ageing site — content and structure included." },
      { title: "WordPress Sites", body: "Editable, well-supported builds for teams who want to manage content." },
    ],
    faq: [
  ...
  },
  {
    ...
    included: [
      { title: "iOS Applications", body: "Built and submitted to the App Store under your own developer account." },
      { title: "Android Applications", body: "Play Store release with device testing across screen sizes." },
      { title: "Cross-platform Apps", body: "One codebase, both stores, lower build and upkeep cost." },
      { title: "Business Applications", body: "Internal tools, bookings, stock, staff and ordering systems." },
      { title: "Customer Portals", body: "Accounts, orders, documents and support in one place." },
      { title: "MVP Development", body: "A first version scoped to prove the idea quickly." },
    ],
    faq: [
  ...
  },
  {
    ...
    included: [
      { title: "Logo Design", body: "A mark and wordmark built to work at every size, on screen and in print." },
      { title: "Brand Identity", body: "Colour, type and usage rules documented so the brand stays consistent." },
      { title: "Print Collateral", body: "Business cards, letterheads, flyers and brochures, print-ready." },
      { title: "Menus & Signage", body: "Hospitality and retail material designed for real-world use." },
      { title: "Social Templates", body: "On-brand templates so your team can post consistently without a designer." },
      { title: "Marketing Material", body: "One-off campaign assets, from posters to exhibition graphics." },
    ],
    faq: [
  ...
  },
  {
    ...
    included: [
      { title: "Wireframes", body: "Low-fidelity layouts that lock structure before visual design starts." },
      { title: "UI Design", body: "High-fidelity screens in your brand, ready for build." },
      { title: "Prototypes", body: "Clickable prototypes for stakeholder review and user testing." },
      { title: "Design Systems", body: "Reusable components so new screens stay consistent as you grow." },
      { title: "Usability Review", body: "An audit of an existing product with concrete fixes." },
      { title: "Handoff", body: "Developer-ready specs, assets and documentation." },
    ],
    faq: [
  ...
  },
  {
    ...
    included: [
      { title: "Store Build", body: "A fully branded storefront on a platform matched to your catalogue size." },
      { title: "Product Setup", body: "Catalogue structure, variants, pricing and inventory configured for you." },
      { title: "Payment Gateways", body: "Card, wallet and buy-now-pay-later options, PCI-compliant by default." },
      { title: "Cart & Checkout", body: "A streamlined checkout tuned to reduce abandonment." },
      { title: "Order Management", body: "Fulfilment, shipping rules and returns handled from one dashboard." },
      { title: "Ongoing Support", body: "Updates, security and performance monitoring after launch." },
    ],
    faq: [
  ...
  },
  {
    ...
    included: [
      { title: "Business Email", body: "Professional email on your own domain, set up and secured." },
      { title: "Domain Management", body: "Registration, renewal and DNS handled so nothing lapses." },
      { title: "Hosting", body: "Fast, monitored hosting matched to what your site actually needs." },
      { title: "Cloud Solutions", body: "Storage, backup and infrastructure set up for reliability." },
      { title: "Technical Consultancy", body: "Plain-language advice before you commit to a platform or vendor." },
      { title: "Migrations", body: "Moving email, domains or hosting without downtime." },
    ],
    faq: [
  ...
  },
  {
    ...
    included: [
      { title: "Website Updates", body: "Core, plugin and platform updates applied on a schedule." },
      { title: "Security Updates", body: "Patches and monitoring to keep the site out of trouble." },
      { title: "Backups", body: "Regular, tested backups so recovery is never a scramble." },
      { title: "Technical Support", body: "A named contact for issues, not a ticket queue." },
      { title: "Content Changes", body: "Text, image and page updates without needing a developer." },
      { title: "Performance Monitoring", body: "Uptime and speed tracked, with fixes applied before you notice." },
    ],
    faq: [
