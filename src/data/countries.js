// International dialling codes for the contact form's phone field. `iso2` is
// the two-letter country code used to derive the flag emoji at render time —
// storing flags as text would mean 190-odd emoji to keep in sync by hand.
//
// United Kingdom leads the list since that's who is answering the phone;
// everything else follows alphabetically by name.
