      ...
      >
        <div className="container pricing-hero">
          ...
          <div className="pricing-toggle">
            <button className={showPrices ? "is-active" : ""} onClick={() => setShowPrices(true)}>
              Show prices
            </button>
            <button className={!showPrices ? "is-active" : ""} onClick={() => setShowPrices(false)}>
              Request a quote
            </button>
          </div>
        </div>
            ...
            <div className={"card pricing-card" + (t.variant === "accent" ? " pricing-card--accent" : "")} key={t.name}>
              ...
              {showPrices ? (
                <div className={"pricing-card__price" + (t.variant === "accent" ? " is-accent" : "")}>
                  {t.price.includes("from") ? (
                    <>
                      £—<span className="pricing-card__from"> from</span>
                    </>
                  ) : (
                    t.price
                  )}
                ...
                <div className="pricing-card__price">Request a quote</div>
              )}
